...
permalink: /research/
---
<div markdown="1" onmouseover="document.getElementById('nextvir').style.display='block';" onmouseout="document.getElementById('nextvir').style.display='none';">
##### NextVir: Enabling Classification of Tumor-Causing Viruses with Genomic Foundation Models
John Robertson, **Shorya Consul**, [Haris Vikalo](http://users.ece.utexas.edu/~hvikalo/){:target="_blank"}<br>
PLOS Computational Biology, 2025<br>
[Paper](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1013360){:target="_blank"}
<!-- -->
<p markdown="1" style='text-align: justify;' id="nextvir" style="display:none;">
Many cancers are associated with viral infections, yet identifying tumor-causing viruses from sequencing data remains a challenge due to the high diversity of oncoviral families and the limited availability of labeled data. We present <strong>NextVir</strong>, a foundational model-based framework for oncoviral read classification. NextVir is the first method to leverage genomic foundation models for this task, and is capable of distinguishing reads from 9 tumor-causing viruses and humans with an accuracy exceeding 90%.
</p>
</div>  
<!-- --> 
